...
class MenuItemsAdmin extends StatefulWidget {
  String M_id,M_ar_title,M_en_title;
  MenuItemsAdmin(this.M_id,this.M_ar_title,this.M_en_title);

  @override
  _MenuItemsAdminState createState() => _MenuItemsAdminState();
}

class _MenuItemsAdminState extends State<MenuItemsAdmin> {
  ...
  // bool ischeckedMed=false;
  // bool ischeckedLarg=false;
  @override
  void initState() {
    super.initState();
    getData();
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => MyForm2(
                        ...
                        "","",
                       "","","","","",
                        "",0,false,widget.M_id,widget.M_ar_title,widget.M_en_title,true,false,false,false,onSubmit2: onSubmit2,
                        onSubmit3: onSubmit3)));
...
recorddata(){
  ...
  FirebaseDatabase.instance.reference().child("FooditemsList").child(widget.M_id);
